...
- [x] (민우) 입력한 키워드로 리뷰 검색 가능
- [x] (민우) 각 리뷰 게시글의 제목을 클릭하면 게시글 상세 정보 조회 가능
- [x] (민우) 각 리뷰 게시글에 좋아요/취소 가능
...
- [ ] (민우) 제목은 20자 이하로 제한
- [ ] (민우) 본문 내용에 placeholder로 리뷰 게시판 유의사항 고지
- [ ] (민우) 본문에 이미지 첨부 가능
...
- [x] ~~(도원) 각 게시글 내용을 미리보기 할 수 있다. 삭제된 기능~~
